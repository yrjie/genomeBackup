...
if __name__ == "__main__":
    ...
    #print log10PropTest
    #print ''
    #scn(tpath=sys.argv[1],name='norToMappable',norto='mappable')
    #scn(tpath=sys.argv[1],name='result',saveWig=True)
    #scn(tpath=sys.argv[1],name='norToAllUnique',norto='unique')
    scn(tpath=sys.argv[1],name='scn',saveWig=True,wstep=250)
    #nohup python /lilab/kaifuc/danpos/functions.py YoungPPP.sam:Young.sam >log.scn &